...
export default class GameSuperAssessmentCard extends HTMLElement {
  constructor() {
    super();
  ...
  cardStyles() {
    if (this.cardCategory == "who is assessed") {
      this.borderCardColor = 'var(--assessment-who-is-assessed, rgb(43, 105, 141))';
      this.bodyCardColor = 'var(--assessment-who-is-assessed-secondary, rgb(53, 115, 151))';
      ...
      this.bodyCardColor = "var(--assessment-the-assessor-secondary, rgb(135,104,175))";
      this.cardTitleColor = "white";
      ...
      this.bodyCardColor = "var(--assessment-artefact-secondary, rgb(219,41,78))";
      this.cardTitleColor = "white";
      ...
      this.bodyCardColor = "var(--assessment-context-secondary, rgb(251,124,163))";
      ...
      this.bodyCardColor = "var(--assessment-format-secondary, rgb(155,215,154))";
      this.cardTitleColor = "black";
      ...
      this.bodyCardColor = "var(--assessment-timing-secondary, rgb(241,144,40))";
      this.cardTitleColor = "black";
                    ...
                    <div class="card-face back ${this.cardCategory}">
                        ...
                        <div class="card_category">
                            ...
                            <div class="category_text">   
                                ${this.cardTitleShortened}
                            </div>
                        </div>
                        <div class="card_name ${this.cardNameResizeSmaller}">${this.cardName}</div>
                        <div class="card_description">${this.cardDescription}</div>
                        <div class= "card_details">
                            <div class="how">${this.cardDetailsHeader}</div>
                            <div>${this.cardDetails}</div>
                        </div> 
...
customElements.define("game-super-assessment-card", GameSuperAssessmentCard);
